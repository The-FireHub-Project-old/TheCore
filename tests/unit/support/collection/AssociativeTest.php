...
final class AssociativeTest extends Base {
    ...
    public function testAdd ():void {
        ...
        $this->collection->add('middle-name', 'Marry');
     ...
     * @return void
     */
    public function testAddExist ():void {

        $this->expectException(Error::class);

        $this->collection->add('firstname', 'Jenny');
     ...
     * @return void
     */
    public function testReplaceDontExist ():void {
    ...
    public function testSet ():void {
        ...
        $this->collection->set('firstname', 'Jenna');
        $this->collection->set('middle-name', 'Marry');
     ...
     * @return void
     */
    public function testRemoveDontExist ():void {

        $this->expectException(Error::class);

        $this->collection->remove('middle-name');
     ...
     * @return void
     */
    public function testChunkUntil ():void {
        ...
        $this->assertEquals(
            ...
            $this->collection->chunkUntil(fn($value, $key) => $key === 'lastname')->all()
        );
