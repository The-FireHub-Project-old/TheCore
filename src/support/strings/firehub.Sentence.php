...
final class Sentence extends Str {
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\Strings\Word As return.
     ...
     */
    public function spaceless ():Word {

        return Word::from(
            $this->expression()->replace('')->any()->whitespaces()->string // @phpstan-ignore-line
        );
     ...
     * @return \FireHub\Core\Support\Strings\Word Word from this string.
     */
    public function delimit (string $delimiter):Word {

        return Word::from(
            $this->streamline() // @phpstan-ignore-line
