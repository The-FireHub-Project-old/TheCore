...
/**
 * ### Block only certain addresses to proceed
 * @since 1.0.0
 */
final class UntrustedAddresses extends ServerMiddleware {
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\LowLevel\Arr::inArray() To check if the address exists in a blocklist.
    ...
    public function handle (Server $server, Closure $carry):Server {
        ...
        return Arr::inArray($server->remoteAddress(), $this->blocklist)
